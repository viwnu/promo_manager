...
import { AnalyticsPromoCodeUsageDatePreset } from '../types/analytics-promo-code-usage.types';

export class AnalyticsPromoCodeUsageQueryDto {
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({ type: 'string', example: 'used_at', description: 'Sort field' })
  @IsOptional()
  @IsString()
  sortBy?: string;
